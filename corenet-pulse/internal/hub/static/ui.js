...
(() => {
  const dictionaries = {
    "zh-Hant": {
      ...
      themeCoast: "海岸青", themeMidnight: "夜航藍", themeSakura: "霓虹莓", themeAmber: "夕照金",
      langTraditional: "繁體中文", langSimplified: "简体中文", langEnglish: "English",
      heroTitle: "海闊天青，<span>節點一目瞭然。</span>", heroSubtitle: "從東京到彰化，讓每一段連線，都清楚可見。",
      ...
      perPage: "每頁", nodesUnit: "個節點", previous: "← 上一頁", next: "下一頁 →", footerTagline: "讓連線如海風般自在。",
    ...
    "zh-Hans": {
      ...
      themeCoast: "海岸青", themeMidnight: "夜航蓝", themeSakura: "霓虹莓", themeAmber: "夕照金",
      langTraditional: "繁體中文", langSimplified: "简体中文", langEnglish: "English",
      heroTitle: "海阔天青，<span>节点一目了然。</span>", heroSubtitle: "从东京到彰化，让每一段连接，都清楚可见。",
      ...
      perPage: "每页", nodesUnit: "个节点", previous: "← 上一页", next: "下一页 →", footerTagline: "让连接如海风般自在。",
    ...
    en: {
      ...
      themeCoast: "Coastal teal", themeMidnight: "Night blue", themeSakura: "Neon berry", themeAmber: "Sunset gold",
      langTraditional: "繁體中文", langSimplified: "简体中文", langEnglish: "English",
      heroTitle: "Clear horizons. <span>Every node in view.</span>", heroSubtitle: "From Tokyo to Changhua, every connection stays visible.",
      ...
      perPage: "Per page", nodesUnit: "nodes", previous: "← Previous", next: "Next →", footerTagline: "Connections as effortless as a sea breeze.",
  ...
  const allowedThemes = ["coast", "midnight", "sakura", "amber"]
  let language = allowedLanguages.includes(saved.language) ? saved.language : "zh-Hant"
  let theme = allowedThemes.includes(saved.theme) ? saved.theme : "coast"
  ...
  function persist() {
    try {
      ...
      localStorage.setItem("pulse-coast-preferences", JSON.stringify({ ...current, language, theme }))
  ...
  function setTheme(next, announce = true) {
    ...
    if (meta) meta.content = theme === "midnight" ? "#0b1527" : theme === "sakura" ? "#fff3f8" : theme === "amber" ? "#fff8ea" : "#edf8fa"
  ...
  function setLanguage(next, announce = true) {
    ...
    language = next; document.documentElement.lang = language; persist(); translate(); selectButtons()
  ...
  function init() {
    setTheme(theme, false); setLanguage(language, false)
    const button = document.querySelector("#display-toggle"), panel = document.querySelector("#display-panel")
    ...
    document.addEventListener("keydown", event => { if (event.key === "Escape") { setMenu(false); button?.focus() } })
  ...
  window.PulseUI = {
    init, t, translate, setTheme, setLanguage,
